...
public:
	...
	static std::chrono::nanoseconds getElapsed(Timeinfo& info, const std::chrono::time_point<std::chrono::steady_clock>& ref,
		const std::chrono::nanoseconds& accumulator){
	...
	static void convertDuration(Timeinfo& info, const std::chrono::nanoseconds& duration){
